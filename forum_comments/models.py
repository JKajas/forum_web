...
from forum_comments.validators import validate_NIP, validate_domain
...
class OrganizationModel(models.Model):
    ...
    domain_name = models.CharField(max_length=30, validators=[validate_domain,])
...
class UserModel(AbstractBaseUser,PermissionsMixin):
    organization = models.ForeignKey(OrganizationModel, blank=True, null=True, on_delete=models.CASCADE) 
    username = models.CharField(max_length=30)
    email = models.EmailField(max_length=30,unique=True, validators= [validate_email])
